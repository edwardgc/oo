/**
*******************************************************************************
* @file                  $HeadURL: https://beisop70.china.nsn-net.net/isource/svnroot/BTS_SC_CPLANE/trunk/C_Application/SC_UEC/CP_Utilities/Include/UecTupSrbSignallingPort3gppStrategy.hpp $
...
namespace Uec
{
class TupSrbSignallingPort3gppStrategy : public ITupSrbSignallingPortStrategy //CPD_IGNORE_BEGIN
{
public:
    TupSrbSignallingPort3gppStrategy(const ICellData& p_cellData);
